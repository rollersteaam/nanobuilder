class ContextMenu extends UIElement {
    ...
    ContextMenu(float x, float y, float w, float h, color colour) {
        ...
        UIElement createAtomText = uiFactory.createText(16, 8, w - 12, 38, color(70), "Create Atom", LEFT);
        ...
        UIElement deleteSelectionText = uiFactory.createText(16, 8, w - 12, 38, color(70), "Delete", LEFT);
        ...
        UIElement paintText = uiFactory.createText(16, 8, w - 12, 38, color(70), "Paint Red", LEFT);
        ...
        UIElement createElectronText = uiFactory.createText(16, 8, w - 12, 38, color(70), "Create Electron", LEFT);
        ...
        UIElement pushText = uiFactory.createText(16, 8, w - 12, 38, color(70), "Push", LEFT);
        ...
        UIElement insertElectronText = uiFactory.createText(16, 8, w - 12, 38, color(70), "Insert Electron", LEFT);
        ...
        UIElement removeElectronText = uiFactory.createText(16, 8, w - 12, 38, color(70), "Remove Electron", LEFT);
        ...
        UIElement bondAtomsText = uiFactory.createText(16, 8, w - 12, 38, color(70), "Bond Atoms", LEFT);
