class ContextMenu extends UIElement {
    ...
    ContextMenu(float x, float y, float w, float h, color colour) {
        ...
        UIElement createAtomButton = uiFactory.createButton(5, 5, w - 8, 40, color(255, 0, 0, 130), createAtom);
        UIElement createAtomText = uiFactory.createText(16, 13, w - 12, 38, color(70), "Create Atom", LEFT);
        createAtomButton.appendChild(createAtomText);
        appendChild(createAtomButton);

        UIElement deleteSelectionButton = uiFactory.createButton(5, 5 + 40 + 4, w - 8, 40, color(255, 0, 0, 130), delete);
        UIElement deleteSelectionText = uiFactory.createText(16, 13, w - 12, 38, color(70), "Delete", LEFT);
        deleteSelectionButton.appendChild(deleteSelectionText);
        appendChild(deleteSelectionButton);

        UIElement paintButton = uiFactory.createButton(5, 5 + 40 + 40 + 4 + 4, w - 8, 40, color(0, 255, 0, 130), paint);
        UIElement paintText = uiFactory.createText(16, 13, w - 12, 38, color(70), "Paint Red", LEFT);
        paintButton.appendChild(paintText);
        appendChild(paintButton);

        UIElement createElectronButton = uiFactory.createButton(5, 5 + 40 + 40 + 40 + 4 + 4 + 4, w - 8, 40, color(0, 0, 255, 130), createElectron);
        UIElement createElectronText = uiFactory.createText(16, 13, w - 12, 38, color(70), "Create Electron", LEFT);
        createElectronButton.appendChild(createElectronText);
        appendChild(createElectronButton);

        UIElement pushButton = uiFactory.createButton(5, 173 + 4 + 4, w - 8, 40, color(0, 0, 255, 130), push);
        UIElement pushText = uiFactory.createText(16, 13, w - 12, 38, color(70), "Push", LEFT);
        pushButton.appendChild(pushText);
        appendChild(pushButton);

        UIElement insertElectronButton = uiFactory.createButton(5, 226, w - 8, 40, color(0, 0, 255, 130), insertAtomElectron);
        UIElement insertElectronText = uiFactory.createText(16, 13, w - 12, 38, color(70), "Insert Electron", LEFT);
        insertElectronButton.appendChild(insertElectronText);
        appendChild(insertElectronButton);

        UIElement removeElectronButton = uiFactory.createButton(5, 271, w - 8, 40, color(0, 0, 255, 130), removeAtomElectron);
        UIElement removeElectronText = uiFactory.createText(16, 13, w - 12, 38, color(70), "Remove Electron", LEFT);
        removeElectronButton.appendChild(removeElectronText);
        appendChild(removeElectronButton);

        UIElement bondAtomsButton = uiFactory.createButton(5, 316, w - 8, 40, color(0, 0, 255, 130), bondAtoms);
        UIElement bondAtomsText = uiFactory.createText(16, 13, w - 12, 38, color(70), "Bond Atoms", LEFT);
